...
static inline void parse_cli_settings(int argc, const char* argv[])
{
  ...
  if (args_info.ignore_self_flag) {
    if ((osMajorVersion == 11) || (osMajorVersion == 12) || ((osMajorVersion == 10) & (osMinorVersion >= 6))) {
  ...
  if (args_info.file_events_flag) {
    if ((osMajorVersion == 11) || (osMajorVersion == 12) || ((osMajorVersion == 10) & (osMinorVersion >= 7))) {
  ...
  if (args_info.mark_self_flag) {
    if ((osMajorVersion == 11) || (osMajorVersion == 12) || ((osMajorVersion == 10) & (osMinorVersion >= 9))) {
